  ...
  return (
    <footer className="relative border-t border-border bg-surface/50 px-6 lg:px-10 pt-20 pb-10">
      <div className="max-w-7xl mx-auto grid md:grid-cols-[2fr_1fr_1fr] gap-12">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            {[XIcon, InstagramIcon, MusicNoteIcon, WhatsAppIcon].map((Icon, i) => (
              <a
                key={i}
                className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:border-gold hover:text-gold transition-colors cursor-pointer"
              >
        ...
        <div>
          <h4 className="font-mono-tk text-xs uppercase tracking-[0.25em] text-gold mb-5">
            Company
          </h4>
          <ul className="space-y-3 text-foreground/70">
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">About</a>
            </li>
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">Careers</a>
            </li>
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">Contact</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-foreground/70">
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">Privacy</a>
            </li>
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">Terms</a>
            </li>
            <li>
              <a className="hover:text-gold transition-colors cursor-pointer">Cookies</a>
            </li>
          </ul>
        </div>
      </div>
