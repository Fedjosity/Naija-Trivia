    ...
    <section id="pricing" className="relative py-32 px-6 lg:px-10">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <span className="font-mono-tk text-xs uppercase tracking-[0.25em] text-gold">/ Pricing</span>
          <h2 className="font-display text-5xl lg:text-6xl font-bold mt-4">
            Go <span className="text-gold-shimmer">Gold</span>.
          </h2>
          <p className="mt-5 text-foreground/65 text-lg">Free forever. Or unlock the full federation.</p>
          ...
          <div className="inline-flex mt-8 p-1 rounded-full bg-surface border border-border">
            ...
            >
              Yearly
              <span className="text-[10px] font-mono-tk px-1.5 py-0.5 rounded bg-primary text-foreground">−17%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-3xl bg-surface border border-border p-10">
            ...
            <div className="mt-8 font-display text-5xl font-bold">₦0<span className="text-base font-sans text-foreground/55">/forever</span></div>
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-surface-elevated to-surface border border-gold p-10 gold-border-glow lg:scale-[1.03]">
            ...
            <div className="mt-8 font-display text-5xl font-bold text-gold-shimmer transition-all">
              {price}<span className="text-base font-sans text-foreground/55">{period}</span>
            </div>
