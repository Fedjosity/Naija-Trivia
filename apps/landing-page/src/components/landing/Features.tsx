...
const features = [
  { icon: "🎵", title: "Afrobeats & Nollywood", desc: "From Fela to Rema, Tinubu to Tunde Kelani — deep cuts across music and film eras." },
  { icon: "🗺️", title: "All 36 States Covered", desc: "Geography, culture, languages, and trivia rooted in every corner of the federation." },
  { icon: "⚡", title: "Daily Challenges & Streaks", desc: "Fresh questions every day. Build streaks, earn badges, unlock seasonal packs." },
  { icon: "🏆", title: "Live Leaderboards", desc: "Compete by state, region, and nationally. See who really knows Naija best." },
  { icon: "📴", title: "Offline Mode", desc: "Subway, village, NEPA off — your questions are always ready. Sync when you're back." },
  { icon: "🤖", title: "AI Content Engine", desc: "Curated by AI, verified by humans. Always fresh, always factual, always Naija." },
];
    ...
    <section ref={root} id="features" className="relative py-32 px-6 lg:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-2xl mb-20">
          <span className="font-mono-tk text-xs uppercase tracking-[0.25em] text-gold">/ Features</span>
